    ...
    <div className="group cursor-pointer">
      <svg width="90" height="140" viewBox="0 0 90 140" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          ...
          fill="#F5F5F5"
          className="fill-primary-bg group-hover:fill-card-hover transition-all duration-250 ease-in-out"
        />
        <path
          ...
          fill="#AAAAAA"
          className="fill-card-symbol group-hover:fill-card-hover-symbol transition-all duration-250 ease-in-out"
        />
        <path
